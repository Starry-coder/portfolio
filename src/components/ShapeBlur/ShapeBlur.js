...
const fragmentShader = /* glsl */`
  ...
  void main() {
      ...
      // Theme colors: #42FF62 (main green) with glow effect
      vec3 themeGreen = vec3(0.259, 1.0, 0.384); // #42FF62 in RGB
      vec3 glowColor = vec3(0.129, 0.5, 0.192);  // Darker green for glow
      
      // Create gradient effect from center
      vec2 center = vec2(0.5);
      float dist = length(st - center);
      vec3 color = mix(themeGreen, glowColor, dist * 1.5);
